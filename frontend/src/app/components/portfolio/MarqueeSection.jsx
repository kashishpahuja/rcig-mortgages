      ...
      <div className="relative flex flex-col gap-3">
        ...
        <div
          ...
          className={`
            ...
            select-none
            touch-pan-y
            ${row1Drag.isDragging ? 'cursor-grabbing' : 'cursor-grab'}
          `}
          style={{
            transform: `translateX(calc(${offset - 200}px + ${row1Drag.dragX}px))`
          }}
        >
          {row1Loop.map((src, i) => (
            <div
        ...
        <div
          ...
          className={`
            ...
            select-none
            touch-pan-y
            ${row2Drag.isDragging ? 'cursor-grabbing' : 'cursor-grab'}
          `}
          style={{
            transform: `translateX(calc(-${offset - 200}px + ${row2Drag.dragX}px))`
          }}
        >
          {row2Loop.map((src, i) => (
            <div
